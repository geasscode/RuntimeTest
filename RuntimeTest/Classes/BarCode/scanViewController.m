...
- (void)initBgView{
    ...
    //基准线
    UIView* line = [[UIView alloc] initWithFrame:CGRectMake(WNXAppWidth/16, WNXAppHeight/2-0.5, WNXAppWidth/8*7, 1)];
    line.backgroundColor = [UIColor redColor];
    [bgView addSubview:line];
    //上部
    UIView* upView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, WNXAppWidth, WNXAppHeight/6)];
    upView.alpha = 0.4;
    ...
    labIntroudction.frame=CGRectMake(WNXAppWidth/20, WNXAppHeight/24, WNXAppWidth/10*9, 50);
    labIntroudction.numberOfLines=2;
    labIntroudction.textColor=[UIColor whiteColor];
    labIntroudction.text=@"将二维码置于矩形方框内，离手机摄像头10CM左右，系统会自动识别。";
    [upView addSubview:labIntroudction];
    //左侧
    UIView *leftView = [[UIView alloc] initWithFrame:CGRectMake(0, WNXAppHeight/6, WNXAppWidth/16, WNXAppHeight/12*7)];
    leftView.alpha = 0.4;
    leftView.backgroundColor = [UIColor blackColor];
    [bgView addSubview:leftView];
    //右侧
    UIView *rightView = [[UIView alloc] initWithFrame:CGRectMake(WNXAppWidth/16*15, WNXAppHeight/6, WNXAppWidth/16, WNXAppHeight/12*7)];
    rightView.alpha = 0.4;
    rightView.backgroundColor = [UIColor blackColor];
    [bgView addSubview:rightView];
    //底部
    UIView * downView = [[UIView alloc] initWithFrame:CGRectMake(0, WNXAppHeight/4*3, WNXAppWidth, WNXAppHeight/4)];
    downView.alpha = 0.4;
