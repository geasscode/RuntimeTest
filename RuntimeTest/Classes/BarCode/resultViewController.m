...
- (void)viewDidLoad {
    ...
    if ([emailTest evaluateWithObject:self.content]) {
        ...
        //先计算label所需高度
        CGRect tmpRect = [self.content boundingRectWithSize:CGSizeMake(WNXAppWidth, 1000) options:NSStringDrawingUsesLineFragmentOrigin attributes:[NSDictionary dictionaryWithObjectsAndKeys:[UIFont systemFontOfSize:18.0],NSFontAttributeName, nil] context:nil];
        
        UILabel *label = [[UILabel alloc]initWithFrame:CGRectMake(0, 0, WNXAppWidth, tmpRect.size.height)];
