...
- (void)setCategory:(NSArray *)category {
    ...
    if (! [category isEqualToArray:_category]) {
        ...
        CGFloat cellHeight = (CGFloat) ((kScreenWidth * 0.45) / 2);
        for (NSUInteger i = 0; i < category.count; i ++) {
            ...
            [cell mas_makeConstraints:^(MASConstraintMaker * make) {
                make.left.equalTo(self.scrollView).offset(page * kScreenWidth + column * cellWidth);
        ...
        [self.scrollView setContentSize:CGSizeMake(page * kScreenWidth, (CGFloat) (kScreenWidth * 0.45))];
