...
# 项目根目录
project_path = "/Users/z/Documents/desmondFile/iosGithub/RuntimeTest"
# 编译成功后.app所在目录
app_path = "/Users/z/Documents/desmondFile/iosGithub/RuntimeTest/build/Build/Products/Release-iphoneos/RuntimeTest.app"
# 指定项目下编译目录
build_path = "build"
# 打包后ipa存储目录
targerIPA_parth = "/Users/z/Documents/buildIPA"


# firm的api token
fir_api_token = "b668e48c86ec4baf052b4a37899f4eb2"

from_addr = "sai3300@163.com"
password = "fix me"
smtp_server = "smtp.163.com"
to_addr = 'geasscode@outlook.com,872665743@qq.com'
...
def build_project():
    ...
    os.system ('cd %s;xcodebuild -workspace RuntimeTest.xcworkspace  -scheme RuntimeTest -configuration release -derivedDataPath %s ONLY_ACTIVE_ARCH=NO || exit' % (project_path,build_path))
# CONFIGURATION_BUILD_DIR=./build/Release-iphoneos

# 打包ipa 并且保存在桌面
def build_ipa():
    global ipa_filename
    ipa_filename = time.strftime('RuntimeTest_%Y-%m-%d-%H-%M-%S.ipa',time.localtime(time.time()))
